Algoritmo actividadFav
	Definir nombre Como Caracter
	Definir actividadFavorita Como Caracter
	Escribir "ingrese el nombre de un compañero"
	leer nombre
	Escribir "¿cual es su actividad favorita?"
	leer actividadFavorita
	Escribir "La actividad favorita de " nombre " es " actividadFavorita
FinAlgoritmo
